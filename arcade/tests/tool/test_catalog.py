...
def test_create_func_model_with_simple_types_has_correct_fields():
    ...
    check_model_fields(input_model, {
        'param1': (int, "No description provided."),
        'param2': (str, "No description provided.")
    })

    check_model_fields(output_model, {
        'result': (str, "No description provided.") # Not Optional[str] TODO this is inconsistent
    })
...
def test_create_func_model_with_Annotated_has_correct_fields():
    def sample_function(
        param1: Annotated[int, "The first operand"],
        param2: Annotated[str, "The second operand"]
    ...
    check_model_fields(input_model, {
        'param1': (int, "The first operand"),
        'param2': (str, "The second operand")
    })

    check_model_fields(output_model, {
        'result': (Optional[str], "Returns magical things")
    })
