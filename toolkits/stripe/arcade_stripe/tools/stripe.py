...
def create_customer(
    ...
    email: Annotated[Optional[str], "The email of the customer."],
...
def create_product(
    ...
    description: Annotated[Optional[str], "The description of the product."],
...
def list_prices(
    context: ToolContext,
    product: Annotated[Optional[str], "The ID of the product to list prices for."],
    limit: Annotated[
        Optional[int],
        "A limit on the number of objects to be returned. "
        "Limit can range between 1 and 100, and the default is 10.",
...
def list_invoices(
    context: ToolContext,
    customer: Annotated[Optional[str], "The ID of the customer to list invoices for."],
    limit: Annotated[
        Optional[int],
        "A limit on the number of objects to be returned. "
        "Limit can range between 1 and 100, and the default is 10.",
...
def create_invoice(
    ...
    days_until_due: Annotated[Optional[int], "The number of days until the invoice is due."],
...
def create_refund(
    ...
    amount: Annotated[Optional[int], "The amount to refund in cents."],
...
def list_payment_intents(
    context: ToolContext,
    customer: Annotated[Optional[str], "The ID of the customer to list payment intents for."],
    limit: Annotated[
        Optional[int],
        "A limit on the number of objects to be returned. Limit can range between 1 and 100.",
    ],
...
def create_billing_portal_session(
    ...
    return_url: Annotated[Optional[str], "The default URL to return to afterwards."],
