...
from arcade_dropbox.tools.hello import say_hello
...
@tool_eval()
def dropbox_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="dropbox Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to dropbox tools. "
