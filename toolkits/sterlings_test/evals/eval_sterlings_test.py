...
import arcade_sterlings_test
from arcade_sterlings_test.tools.hello import say_hello
...
catalog = ToolCatalog()
catalog.add_module(arcade_sterlings_test)


@tool_eval()
def sterlings_test_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="sterlings_test Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to sterlings_test tools. "
